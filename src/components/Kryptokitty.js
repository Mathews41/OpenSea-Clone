        ...
        <div className='dropdown-buttons'>
          <div className='button'>
            <div className='left-column'>
              <div><MdShowChart className='button-icon'/></div>
              <div><h4>Price History</h4></div>
            </div>
          ...
          <div className='button'>
            <div className='left-column'>
              <div><MdLocalOffer className='button-icon'/></div>
              <div><h4>Listings</h4></div>
            </div>
            <div className='right-column'>
              <FiChevronDown className='right-column-icon'/>
            </div>
          ...
          <div className='button'>
            <div className='left-column'>
              <div><MdList className='button-icon' /></div>
